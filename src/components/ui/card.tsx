...
const BusinessCard: React.FC<BusinessCardProps> = ({ business, onPress }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-700 shadow-md rounded-lg p-4 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-105 hover:bg-zinc-200 duration-300 cursor-pointer" onClick={()=>onPress(business)}>
      <div className="mb-4">
